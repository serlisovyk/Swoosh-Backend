...
export const INDIVIDUAL_ORDER_NAME_STRING_ERROR = 'Имя должно быть строкой'
...
export const INDIVIDUAL_ORDER_PHONE_STRING_ERROR = 'Телефон должен быть строкой'
...
export const INDIVIDUAL_ORDER_EMAIL_STRING_ERROR = 'Email должен быть строкой'
export const INDIVIDUAL_ORDER_EMAIL_EMPTY_ERROR = 'Email обязателен'
export const INDIVIDUAL_ORDER_EMAIL_FORMAT_ERROR = 'Некорректный формат email'
...
export const INDIVIDUAL_ORDER_STATUS_ERROR = 'Некорректное значение статуса'
...
export const INDIVIDUAL_ORDER_LIMIT_MIN_ERROR = 'Лимит должен быть не меньше 1'
export const INDIVIDUAL_ORDER_LIMIT_MAX_ERROR =
  'Лимит должен быть не больше 100'
export const INDIVIDUAL_ORDER_SORT_ERROR = 'Некорректное значение сортировки'
export const INDIVIDUAL_ORDER_NOT_FOUND_ERROR = 'Индивидуальный заказ не найден'
